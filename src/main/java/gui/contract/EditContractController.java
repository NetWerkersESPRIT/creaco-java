...
public class EditContractController {
    ...
    private gui.collab.contract.DisplayContractController listController;
    private Contract currentContract;

    public void setListController(gui.collab.contract.DisplayContractController listController) {
    ...
    private void handleSave() {
        try {
            ...
            if (listController != null) {
                listController.loadContractsData();
            }
            closeWindow();
