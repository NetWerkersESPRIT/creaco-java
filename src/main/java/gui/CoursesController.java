...
public class CoursesController {
    ...
    private void onSendQuestion() {
        if (FrontMainController.getInstance() != null) {
            FrontMainController.getInstance().onShowHelpTicketForm(null);
        }
    }

    private void onEditTicket(HelpTicket t) {
        if (FrontMainController.getInstance() != null) {
            FrontMainController.getInstance().onShowHelpTicketForm(t);
        }
    }
    ...
    private void onGoToLeaderboard() {
        if (FrontMainController.getInstance() != null) {
            FrontMainController.getInstance().onShowLeaderboard();
        }
    }
